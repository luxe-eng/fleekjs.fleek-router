...
var router = function(app, _config) {
  ...
  _.each(swagger.sanitizedRoutes, function(routeObj) {
    ...
    if (routeObj.authRequired) {
      secureRouter[routeObj.method](path, bindRouteData, authenticate, validate, middleware, methodHandler);
    } else {
      publicRouter[routeObj.method](path, bindRouteData, validate, middleware, methodHandler);
    }
  });
